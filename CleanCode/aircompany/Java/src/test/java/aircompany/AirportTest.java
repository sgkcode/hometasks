...
public class AirportTest {
  ...
  public void testGetTransportMilitaryPlanes() {
    ...
    assertThat(airport.getTransportMilitaryPlanes())
        .extracting(MilitaryPlane::getType)
        .containsOnly(MilitaryType.TRANSPORT);
  }
  ...
  public void testNextPlaneMaxLoadCapacityIsHigherThanCurrent() {
    ...
    assertThat(airport.getPlanes())
        .extracting(Plane::getMaxLoadCapacity)
        .isSorted();
  }
  ...
  public void testHasAtLeastOneBomberInMilitaryPlanes() {
    Airport airport = new Airport(planes);
    assertThat(airport.getMilitaryPlanes())
        .extracting(MilitaryPlane::getType)
        .contains(MilitaryType.BOMBER);
  }

  @Test
  public void testExperimentalPlanesHasClassificationLevelHigherThanUnclassified() {
    Airport airport = new Airport(planes);
    assertThat(airport.getExperimentalPlanes())
        .extracting(ExperimentalPlane::getClassificationLevel)
        .doesNotContain(ClassificationLevel.UNCLASSIFIED);
  }
}
